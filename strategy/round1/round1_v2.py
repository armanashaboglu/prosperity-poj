...
PARAMS = {
    "global": {
        "window_size": 4,          # Matched prototype.py
        "soft_limit_factor": 0.5,  # Matched prototype.py (50% limit)
        "skew_offset": 1,          # Matched prototype.py (+/- 1 price adjust)
        "soft_liq_offset": 2,      # Matched prototype.py (+/- 2 price for soft liq)
        "hard_liq_offset": 0,      # Matched prototype.py (+/- 0 price for hard liq)
        "liq_pct": 0.5,            # Matched prototype.py (50% capacity)
        "make_offset": 1,          # Closest approximation to prototype's make logic
    },
    ...
    Product.SQUID_INK: {
        # Inherits global MM params - RSI parameters removed
    },
}
# --- End Updated PARAMS ---
